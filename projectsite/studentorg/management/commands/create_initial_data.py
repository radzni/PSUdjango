...
class Command(BaseCommand):
    ...
    def create_organization(self, count):
        ...
        self.stdout.write(self.style.SUCCESS('innitial data for organizations created successfully.'))
    ...
    def create_students(self, count):
        ...
        self.stdout.write(self.style.SUCCESS('innitial data for students created successfully.'))
    ...
    def create_membership(self, count):
        ...
        for _ in range(count):
            OrgMember.objects.create(
                ...
                date_joined=faker.date_between(start_date='-2y', end_date='today')
            )
        self.stdout.write(self.style.SUCCESS('innitial data for membership created successfully.'))
